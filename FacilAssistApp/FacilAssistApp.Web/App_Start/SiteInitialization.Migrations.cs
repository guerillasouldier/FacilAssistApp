namespace FacilAssistApp
{
    ...
    public static partial class SiteInitialization
    {
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want FacilAssistApp migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Targets = new[] { typeof(SiteInitialization).Assembly.Location },
                    Task = "migrate:up",
                    WorkingDirectory = Path.GetDirectoryName(typeof(SiteInitialization).Assembly.Location),
                    Namespace = "FacilAssistApp.Migrations." + databaseKey + "DB"
                };
