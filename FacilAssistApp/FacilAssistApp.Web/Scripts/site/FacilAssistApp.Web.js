...
(function (FacilAssistApp) {
    ...
    })(Administration = FacilAssistApp.Administration || (FacilAssistApp.Administration = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Administration;
    (function (Administration) {
...
(function (FacilAssistApp) {
    ...
    })(Authorization = FacilAssistApp.Authorization || (FacilAssistApp.Authorization = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Administration;
...
(function (FacilAssistApp) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('FacilAssistApp');
    })(ScriptInitialization = FacilAssistApp.ScriptInitialization || (FacilAssistApp.ScriptInitialization = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    ...
    FacilAssistApp.BasicProgressDialog = BasicProgressDialog;
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new FacilAssistApp.BasicProgressDialog();
    ...
    })(Common = FacilAssistApp.Common || (FacilAssistApp.Common = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var DialogUtils;
    ...
    })(DialogUtils = FacilAssistApp.DialogUtils || (FacilAssistApp.DialogUtils = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Common;
...
(function (FacilAssistApp) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = FacilAssistApp.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = FacilAssistApp.LanguageList || (FacilAssistApp.LanguageList = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Common;
...
(function (FacilAssistApp) {
    ...
    })(Membership = FacilAssistApp.Membership || (FacilAssistApp.Membership = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var Membership;
...
(function (FacilAssistApp) {
    var WorkOrderDB;
    (function (WorkOrderDB) {
        var WorkOrdersForm = (function (_super) {
            __extends(WorkOrdersForm, _super);
            function WorkOrdersForm() {
                _super.apply(this, arguments);
            }
            WorkOrdersForm.formKey = 'WorkOrderDB.WorkOrders';
            return WorkOrdersForm;
        }(Serenity.PrefixedContext));
        WorkOrderDB.WorkOrdersForm = WorkOrdersForm;
        [['Pkey', function () { return Serenity.IntegerEditor; }], ['WoNum', function () { return Serenity.IntegerEditor; }], ['WoType', function () { return Serenity.StringEditor; }], ['Description', function () { return Serenity.StringEditor; }], ['DateAdded', function () { return Serenity.DateEditor; }], ['DateCompleted', function () { return Serenity.DateEditor; }], ['AssetId', function () { return Serenity.StringEditor; }], ['Priority', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(WorkOrdersForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(WorkOrderDB = FacilAssistApp.WorkOrderDB || (FacilAssistApp.WorkOrderDB = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var WorkOrderDB;
    (function (WorkOrderDB) {
        var WorkOrdersRow;
        (function (WorkOrdersRow) {
            WorkOrdersRow.idProperty = 'Pkey';
            WorkOrdersRow.nameProperty = 'WoType';
            WorkOrdersRow.localTextPrefix = 'WorkOrderDB.WorkOrders';
            var Fields;
            (function (Fields) {
            })(Fields = WorkOrdersRow.Fields || (WorkOrdersRow.Fields = {}));
            ['Pkey', 'WoNum', 'WoType', 'Description', 'DateAdded', 'DateCompleted', 'AssetId', 'Priority'].forEach(function (x) { return Fields[x] = x; });
        })(WorkOrdersRow = WorkOrderDB.WorkOrdersRow || (WorkOrderDB.WorkOrdersRow = {}));
    })(WorkOrderDB = FacilAssistApp.WorkOrderDB || (FacilAssistApp.WorkOrderDB = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    ...
    (function (WorkOrderDB) {
        ...
        (function (WorkOrdersService) {
            WorkOrdersService.baseUrl = 'WorkOrderDB/WorkOrders';
            var Methods;
            (function (Methods) {
            })(Methods = WorkOrdersService.Methods || (WorkOrdersService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                WorkOrdersService[x] = function (r, s, o) { return Q.serviceRequest(WorkOrdersService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = WorkOrdersService.baseUrl + '/' + x;
            });
        })(WorkOrdersService = WorkOrderDB.WorkOrdersService || (WorkOrderDB.WorkOrdersService = {}));
    })(WorkOrderDB = FacilAssistApp.WorkOrderDB || (FacilAssistApp.WorkOrderDB = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
                    ...
                    onSuccess: function (response) {
                        ...
                        if (pageNumbers) {
                            var footer = function (data) {
                                ...
                                doc.autoTableText(str, doc.internal.pageSize.width / 2, doc.internal.pageSize.height - (pageNumbers ? 25 : 30), {
                                    halign: 'center'
                                });
                            };
                            autoOptions.hasOwnProperty = (footer);
                        }
...
(function (FacilAssistApp) {
    var WorkOrderDB;
    (function (WorkOrderDB) {
        var WorkOrdersDialog = (function (_super) {
            __extends(WorkOrdersDialog, _super);
            function WorkOrdersDialog() {
                _super.apply(this, arguments);
                this.form = new WorkOrderDB.WorkOrdersForm(this.idPrefix);
            }
            WorkOrdersDialog.prototype.getFormKey = function () { return WorkOrderDB.WorkOrdersForm.formKey; };
            WorkOrdersDialog.prototype.getIdProperty = function () { return WorkOrderDB.WorkOrdersRow.idProperty; };
            WorkOrdersDialog.prototype.getLocalTextPrefix = function () { return WorkOrderDB.WorkOrdersRow.localTextPrefix; };
            WorkOrdersDialog.prototype.getNameProperty = function () { return WorkOrderDB.WorkOrdersRow.nameProperty; };
            WorkOrdersDialog.prototype.getService = function () { return WorkOrderDB.WorkOrdersService.baseUrl; };
            WorkOrdersDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], WorkOrdersDialog);
            return WorkOrdersDialog;
        }(Serenity.EntityDialog));
        WorkOrderDB.WorkOrdersDialog = WorkOrdersDialog;
    })(WorkOrderDB = FacilAssistApp.WorkOrderDB || (FacilAssistApp.WorkOrderDB = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
var FacilAssistApp;
(function (FacilAssistApp) {
    var WorkOrderDB;
    (function (WorkOrderDB) {
        var WorkOrdersGrid = (function (_super) {
            __extends(WorkOrdersGrid, _super);
            function WorkOrdersGrid(container) {
                _super.call(this, container);
            }
            WorkOrdersGrid.prototype.getColumnsKey = function () { return 'WorkOrderDB.WorkOrders'; };
            WorkOrdersGrid.prototype.getDialogType = function () { return WorkOrderDB.WorkOrdersDialog; };
            WorkOrdersGrid.prototype.getIdProperty = function () { return WorkOrderDB.WorkOrdersRow.idProperty; };
            WorkOrdersGrid.prototype.getLocalTextPrefix = function () { return WorkOrderDB.WorkOrdersRow.localTextPrefix; };
            WorkOrdersGrid.prototype.getService = function () { return WorkOrderDB.WorkOrdersService.baseUrl; };
            WorkOrdersGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], WorkOrdersGrid);
            return WorkOrdersGrid;
        }(Serenity.EntityGrid));
        WorkOrderDB.WorkOrdersGrid = WorkOrdersGrid;
    })(WorkOrderDB = FacilAssistApp.WorkOrderDB || (FacilAssistApp.WorkOrderDB = {}));
})(FacilAssistApp || (FacilAssistApp = {}));
//# sourceMappingURL=FacilAssistApp.Web.js.map