...
namespace FacilAssistApp.Modules
{
    [NestedLocalTexts]
    public static class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your FacilAssist Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to FacilAssist";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your FacilAssist Account";
                    ...
                    public static LocalText FormTitle = "Sign up for FacilAssist";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "FacilAssist";
        }
        ...
        public static class Site
        {
            public static class Dashboard
            {
                public static LocalText ContentDescription =
                    "a sample with random data using the AdminLTE theme.";
            }
