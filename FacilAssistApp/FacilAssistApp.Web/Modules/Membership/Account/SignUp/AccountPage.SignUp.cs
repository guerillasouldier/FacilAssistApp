...
namespace FacilAssistApp.Modules.Membership.Account.SignUp
{
    public partial class AccountController : Controller
    {
        ...
        {
            return View(Views.Membership.Account.SignUp.AccountSignUp);
        }
            ...
            return this.UseConnection("Default", connection =>
            {
                ...
                using (var uow = new UnitOfWork(connection))
                {
                    ...
                    var emailBody = TemplateHelper.RenderTemplate(
                        Views.Membership.Account.SignUp.AccountActivateEmail, emailModel);
                ...
                try
                {
                    ...
                    using (var br = new BinaryReader(ms))
                    {
                        ...
                        if (dt < DateTime.UtcNow)
                            return Content(Texts.Validation.InvalidActivateToken);
