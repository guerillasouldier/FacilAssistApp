...
using FacilAssistApp.Modules.Membership.Account.ResetPassword;
using MVC;
using Serenity;
using Serenity.Data;
...
namespace FacilAssistApp.Modules.Membership.Account.ForgotPassword
{
    public partial class AccountController : Controller
    {
        ...
        {
            return View(Views.Membership.Account.ForgotPassword.AccountForgotPassword);
        }
        ...
        public Result<ServiceResponse> ForgotPassword(ForgotPasswordRequest request)
        {
            return this.UseConnection("Default", connection =>
            {
                ...
                var emailBody = TemplateHelper.RenderTemplate(
                    Views.Membership.Account.ResetPassword.AccountResetPasswordEmail, emailModel);
