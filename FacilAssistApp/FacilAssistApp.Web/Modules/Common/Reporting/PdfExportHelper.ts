namespace FacilAssistApp.Common {
    ...
    export namespace PdfExportHelper {
        ...
        export function exportToPdf(options: IPdfExportOptions): void {
                    ...
                    if (pageNumbers) {
                        const footer = data => {
                            ...
                            doc.autoTableText(str, doc.internal.pageSize.width / 2,
                                doc.internal.pageSize.height - (pageNumbers ? 25 : 30), {
                                    halign: 'center'
                                });
                        };
                        autoOptions.hasOwnProperty = ((footer) as (v: string) => boolean);
                    }
        ...
        export function createToolButton(options: IPdfExportOptions) {
