using FacilAssistApp.Modules.Administration.Language;
using FacilAssistApp.Modules.Administration.Role;
using FacilAssistApp.Modules.Administration.Translation;
using FacilAssistApp.Modules.Administration.User;
using Serenity.Navigation;

[assembly: NavigationLink(1000, "Dashboard", url: "~/", permission: "", icon: "icon-speedometer")]

//[assembly: NavigationMenu(5000, "Work Orders", icon: "icon-anchor")]
//[assembly: NavigationLink(5100, "Worker Orders/Breakdowns", typeof(OrderController), icon: "icon-wallet")]
//[assembly: NavigationLink(5200, "Work Orders/Currently Open", typeof(OrderController), icon: "fa-folder")]
//[assembly: NavigationLink(5300, "Work Orders/Campus Map", typeof(ProductController), icon: "icon-present")]

[assembly: NavigationMenu(7000, "Northwind", icon: "icon-anchor")]
//[assembly: NavigationLink(7100, "Northwind/Customers", typeof(CustomerController), icon: "icon-wallet")]
//[assembly: NavigationLink(7200, "Northwind/Orders", typeof(OrderController), icon: "icon-basket-loaded")]
//[assembly: NavigationLink(7300, "Northwind/Products", typeof(ProductController), icon: "icon-present")]
//[assembly: NavigationLink(7400, "Northwind/Suppliers", typeof(SupplierController), icon: "icon-magic-wand")]
//[assembly: NavigationLink(7500, "Northwind/Shippers", typeof(ShipperController), icon: "icon-plane")]
//[assembly: NavigationLink(7600, "Northwind/Categories", typeof(CategoryController), icon: "icon-folder-alt")]
//[assembly: NavigationLink(7700, "Northwind/Regions", typeof(RegionController), icon: "icon-map")]
//[assembly: NavigationLink(7800, "Northwind/Territories", typeof(TerritoryController), icon: "icon-puzzle")]

//[assembly: NavigationMenu(7900, "Basic Samples", icon: "icon-magic-wand")]
//[assembly: NavigationMenu(7900, "Basic Samples/Dialogs")]
//[assembly: NavigationLink(7900, "Basic Samples/Dialogs/Chart in a Dialog", typeof(BasicSamplesController), action: "ChartInDialog")]
//[assembly: NavigationLink(7900, "Basic Samples/Dialogs/Cloneable Entity Dialog", typeof(BasicSamplesController), action: "CloneableEntityDialog")]
//[assembly: NavigationLink(7900, "Basic Samples/Dialogs/Default Values in New Dialog", typeof(BasicSamplesController), action: "DefaultValuesInNewDialog")]
//[assembly: NavigationLink(7900, "Basic Samples/Dialogs/Multi Column Dialog", typeof(BasicSamplesController), action: "MultiColumnResponsiveDialog")]
//[assembly: NavigationLink(7900, "Basic Samples/Dialogs/Responsive Dialog", typeof(BasicSamplesController), action: "ResponsiveDialog")]
//[assembly: NavigationMenu(7900, "Basic Samples/Editors")]
//[assembly: NavigationLink(7900, "Basic Samples/Editors/Filtered Lookup in Detail.", typeof(BasicSamplesController), action: "FilteredLookupInDetailDialog")]
//[assembly: NavigationLink(7900, "Basic Samples/Editors/Lookup Filter by Multi Val.", typeof(BasicSamplesController), action: "LookupFilterByMultipleValues")]
//[assembly: NavigationMenu(7900, "Basic Samples/Grids")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/Cancellable Bulk Action", typeof(BasicSamplesController), action: "CancellableBulkAction")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/Conditional Formatting", typeof(BasicSamplesController), action: "ConditionalFormatting")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/Custom Links In Grid", typeof(BasicSamplesController), action: "CustomLinksInGrid")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/Grouping and Sum. In Grid", typeof(BasicSamplesController), action: "GroupingAndSummariesInGrid")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/Grid Filtered by Criteria", typeof(BasicSamplesController), action: "GridFilteredByCriteria")]
//[assembly: NavigationLink(7900, "Basic Samples/Grids/View Without ID", typeof(BasicSamplesController), action: "ViewWithoutID")]
...
[assembly: NavigationLink(9100, "Administration/Languages", typeof(LanguageController), icon: "icon-bubbles")]
[assembly: NavigationLink(9200, "Administration/Translations", typeof(TranslationController), icon: "icon-speech")]
[assembly: NavigationLink(9300, "Administration/Roles", typeof(RoleController), icon: "icon-lock")]
[assembly: NavigationLink(9400, "Administration/User Management", typeof(UserController), icon: "icon-people")]