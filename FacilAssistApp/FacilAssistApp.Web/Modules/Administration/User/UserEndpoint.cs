...
namespace FacilAssistApp.Modules.Administration.User
{
    ...
    public partial class UserController
    {
        ...
        private static string[] _permissionsUsedFromScript;
        ...
        public ScriptUserDefinition GetUserData()
        {
            ...
            result.Permissions = TwoLevelCache.GetLocalStoreOnly("ScriptUserPermissions:" + user.Id, TimeSpan.Zero,
                UserPermissionRow.Fields.GenerationKey, () =>
                {
                    ...
                    if (_permissionsUsedFromScript == null)
                    {
                        _permissionsUsedFromScript = new UserPermissionRepository().ListPermissionKeys().Entities
                            .Where(permissionKey =>
                            {
                    ...
                    foreach (var permissionKey in _permissionsUsedFromScript)
                    {
